! function (e, t) {
    ...
    return function () {
        function v(t) {
            ...
            if (e(this, v), this.index = 0, this.selector = t, this.options = n, this.imageElements = [], n.zoom = Object.assign({}, p.zoom, n.zoom || {}), this.config = Object.assign({}, p, n), !t || "string" != typeof t) throw new Error("ImagePreviewer plugin should css string selector that on first params,like #el,.el");
        ...
        return y = v, x = [{
            ...
            value: function () {
                ...
                this.imageElements.forEach((function (t, n) {
                    ...
                    var n = e.config.zoom,
                        ...
                        o = n.max,
                        s = n.step;
                    t.wheelDelta > 0 && g < o ? g += s : g > i && (g -= s), h.style.setProperty("--scale", "".concat(g.toFixed(2)))
            ...
            value: function (e, t) {
                ...
                g = s(c, d, n), f = {
                    ...
                    scale: g,
                    rotate: 0
                }, h.src = i[t].src, a(h, c, d, p, y), setTimeout((function () {
            ...
            key: "handleClose",
            value: function () {
                var e, t, n, i, s, a = this.config.opacity,
                    d = this.imageElements[this.index];
                if (e = d, t = window.innerHeight || document.documentElement.clientHeight || document.body.clientHeight, n = e.offsetTop, i = e.offsetHeight, s = document.documentElement.scrollTop, i + n > s && n - s <= t + 100) {
                    o(m, {
                        start: a,
                        end: 0,
                        step: -.02,
            ...
            value: function (e) {
                var t = this.config.ratio,
                    ...
                    o = n.width,
                    c = n.src;
                h.classList.add("moving"), a(h, o, i, u / 2 - o / 2, r / 2 - i / 2), f = {
                    endX: 0,
                    endY: 0,
                    scale: s(o, i, t),
                    rotate: 0
                }, h.src = c, v.setImageAnimationParams(f), setTimeout((function () {
            ...
            value: function () {
                ...
                e ? m = e : ((m = document.createElement("div")).classList.add("image-preview-container"),
                    m.id = "app", m.innerHTML = '<div class="preview-header">\n ' +
                    '                       <div class="nums">\n\n                            <p>\n ' +
                    ...
                    '<button id="rotate-right" data-tooltip="Rotate Left"><i class="iconfont icon-xuanzhuan1">' +
                    '</i></button>\n <button id="reset" data-tooltip="Reset"><i class="iconfont icon-zhongzhi">' +
