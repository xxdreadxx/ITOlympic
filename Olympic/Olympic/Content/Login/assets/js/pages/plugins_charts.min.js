$(function () {
    ...
    altair_charts = {
        metrics_graphics: function () {
            ...
            var n = "#mg_chart_confidence_band", s = $(n).height();
            if ($(n).length) {
                function t() {
                    var t = $(n).width();
        ...
        c3js: function () {
            ...
            if ($(n).length) {
                ...
                $(n).waypoint({
                    ...
                    offset: "80%"
                }), $window.on("debouncedresize", function () { a.resize() })
            }
            ...
            if ($(d).length) {
                ...
                $(d).waypoint({
                    ...
                    offset: "80%"
                }), $window.on("debouncedresize", function () { c.resize() })
            }
        ...
        chartist_charts: function () {
            ...
            var s = new Chartist.Pie("#chartist_pie_custom_labels", o, {
                labelInterpolationFnc: function (e) {
                    return e[0]
                }
            ...
            $window.on("resize", function () {
                ...
                if ("slice" === e.type) {
                    ...
                    0 !== e.index && (n["stroke-dashoffset"].begin = "anim" + (e.index - 1) + ".end"),
                ...
                window.__anim21278907124 && (
                    ...
                    window.__anim21278907124 = setTimeout(d.update.bind(d), 1e4)
            })
        }
    };