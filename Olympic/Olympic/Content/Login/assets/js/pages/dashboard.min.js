$(function () {
    ...
    chartist_charts: function () {
        new Chartist.Bar("#ct-chart",{
                ...
                series: [
                    [5, 4, 3, 7], [3, 2, 9, 5], [1, 5, 8, 4], [2, 3, 4, 6], [4, 1, 2, 1]
                ]
            },
            {
                stackBars: !0,
            ...
            [
                ["screen and (min-width: 400px)", {
                    reverseData: !0, horizontalBars: !0,
                    axisX: {
    ...
    c3js: function () {
        var r = "#c3_chart_area_stacked"; if ($(r).length) {
            var s = c3.generate({
                bindto: r,
                data: {
                    columns: [
    ...
    peity_charts: function () {
        ...
        $(".countUpMe").each(function () {
            var e = $(this).text(); theAnimation = new CountUp(this, 0, e, 0, 2), theAnimation.start()
        })
        ...
        if (i.length) {
            ...
            theCalendar = i.clndr({
                ...
                render: function (e) {
                    ...
                    click: function (e) {
                        if (e.events.length) {
                            var t = $(".clndr_events"), a = e.date._i; $(e.element).siblings(".day").removeClass("day-active").end().addClass("day-active"),
            ...
            function r() {
                ...
                if ("" == $(e).val())
                    return $(e).addClass("md-input-danger").focus(), altair_md.update_input($(e)), !1;
                if ("" == $(a).val())
                    return $(a).addClass("md-input-danger").focus(), altair_md.update_input($(a)), !1;
                var r = [{
                    date: $(a).val(),
                    title: $(e).val(),
            ...
            } l(), $(window).on("debouncedresize", function () { l() })
        }
    },
    video_player: function () {
        ...
        i.length && (n.on("click", "li", function (e) {
            ...
            var t = $(this);
            if (!t.hasClass(r)) {
                var a = "https://www.youtube.com/embed/" + t.attr("data-video-src") + "?rel=0"; n.children("li").removeClass(r),
                    t.addClass(r),
                    i.velocity({
                        translateZ: 0,
                        scale: 0,
