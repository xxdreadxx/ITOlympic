        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.status == true) {
                    ...
                    $('#NewBirthday').val(result.data.NgaySinh);
...
function Save() {
    ...
    var id = $('#id').val();
    var gioitinh = document.getElementById('radNewGender');
    var kichhoat = document.getElementById('activeKH');
    ...
    if (isSave == true) {
        ...
        formData.append("Phone", $('#NewPhone').val());
        ...
        if (kichhoat.checked == true) {
            formData.append("KichHoat", 1);
        }
        else {
            formData.append("KichHoat", 0);
        }
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.status == true) {
                    ...
                    if (id == 0) {
                        $('#noidung').text('Thêm mới giáo viên thành công.')

                    }
                    else {
                        $('#noidung').text('Cập nhật giáo viên thành công.')
                    }
                    $('#modalThongBao').modal('show');
                    setTimeout(function () { $('#modalThongBao').modal('hide'); }, 4000);
                    location.reload();
                }
            },
            error: function (err) {
